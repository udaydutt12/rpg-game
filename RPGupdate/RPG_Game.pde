...
void combatScreen()
{
  ...
  button3 = new Button("Attack", width/10-100, height*7/8 -60,210, 60, color(0), color(#468BFF), color(255));
  button3.display();
  button4 = new Button("Abilities", width/10-100, height*7/8,210, 60, color(0), color(#468BFF), color(255));
  button4.display();
  hero.displayhp();
  hero.displaymp();
  hades.displayhp();
...
void pauseScreen() {
  ...
  saveButton = new Button("Save", width/2 - 40, height/2, 60, 60, color(0), color(#468BFF), color(255));
  saveButton.display();
}